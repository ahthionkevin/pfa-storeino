    ...
    <transition name="slideleft">
        <div :class="$store.state.showHeaderMenu ? 'move-in' : 'move-out'" class="transition-all delay-500 max-w-full relative flex flex-col bg-gray-100 w-80">
            ...
            <div class="border-t border-b p-2 bg-white my-2 flex justify-center">
                <router-link v-if="$store.state.settings.sections.header.icons.account" to="/account" title="Account" class="item p-2 bg-gray-100 rounded-md mx-1 hover:bg-gray-200">
                ...
                <router-link v-if="$store.state.settings.sections.header.icons.wishlist" to="/wishlist" title="Wishlist" class="item p-2 bg-gray-100 rounded-md mx-1 hover:bg-gray-200 relative">
            ...
            otherMenu: [
                {
                    ...
                    childrens: this.$store.state.settings.store_languages.map(l=> {
                        return {
                            _id: l.code,
                            text: l.name,
                            url: `?lang=${l.code}`
                ...
                },
                {
                    ...
                    childrens: this.$store.state.settings.store_currencies.map(c=> {
                        return {
                            _id: c.code,
                            text: c.name,
                            url: `?cur=${c.code}`
