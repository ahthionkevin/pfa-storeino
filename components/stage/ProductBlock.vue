        ...
        <div class="card">
            <div class="imgBx bore relative">
                ...
                <div class="price absolute top-3 left-2 p-1 text-white rounded-xl">
                    ...
                    <span class="real font-semibold">{{ formatPrice(item.price.salePrice).split(".")[0] }}<sup>.{{ formatPrice(item.price.salePrice).split(".")[1] }}</sup> {{ $store.state.currency.symbol }}</span>
                </div>
                <ul class="action">
            ...
            <div class="content">
                <div class="productName text-center">
                    <h3 class="pt-4">{{this.item.name}}</h3>
